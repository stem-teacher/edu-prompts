...
# 1. Clean up ALL old content directories to ensure a pristine build environment
echo "Cleaning all old content directories..."
rm -rf modules/ extended-response/ knowledge-graph/ multiple-choice-practice-tests/ notes/ plans/ prompts/ scripts/ short-answer/ tracking/
rm -f *.qmd styles.css CNAME

# 2. Re-create the essential directory structure
echo "Creating directory structure..."
mkdir -p modules scripts

# 3. Re-create the CNAME file
echo "Creating CNAME file..."
echo "12IS.wcs.mentormind.com.au" > CNAME

# 4. Re-create placeholder and index pages
...
# 5. Generate module pages from the Knowledge Graph
